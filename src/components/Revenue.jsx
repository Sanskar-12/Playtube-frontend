...
import { setContentRevenueData } from "../redux/reducers/contentSlice";
...
const Revenue = () => {
  ...
  useEffect(() => {
    dispatch(setContentRevenueData(totalRevenue));
